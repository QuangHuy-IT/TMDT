/**
 * Dữ liệu tỉnh/thành phố Việt Nam (lấy từ https://provinces.open-api.vn/api/v2/p/)
 * Dùng cho lookup name→code và code→name.
 * KHÔNG dùng để fetch wards — dùng ProvincesService.getWardsByProvinceCode() thay thế.
 */
...
export const getProvinceByCode = (code) =>
  PROVINCES.find(p => p.code === String(code)) || null;
...
/**
 * @deprecated WARDS mock data đã bị xóa.
 * Dùng ProvincesService.getWardsByProvinceCode() thay thế.
 */
